...
import com.frigora.frigoraplatform.iam.interfaces.rest.resources.SignUpResource;
import com.frigora.frigoraplatform.iam.interfaces.rest.transform.AuthenticatedUserResourceFromEntityAssembler;
import com.frigora.frigoraplatform.iam.interfaces.rest.transform.SignInCommandFromResourceAssembler;
import com.frigora.frigoraplatform.iam.interfaces.rest.transform.SignUpCommandFromResourceAssembler;
import com.frigora.frigoraplatform.shared.interfaces.rest.resources.MessageResource;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> signUp(@RequestBody SignUpResource signUpResource) {
        ...
        return ResponseEntity.ok(new MessageResource("User created successfully"));
    }
}
